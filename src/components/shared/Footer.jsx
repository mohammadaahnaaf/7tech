  ...
  return (
    ...
    <footer className="p-4 border-t-2 border-red-600 bg-black sm:p-6">
          ...
          <div>
            ...
            <ul className="text-gray-200">
              <li className="mb-2">
                ...
                <p className='flex items-center mt-2  hover:text-red-600'>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  +8801911444466
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://7tech.vercel.app/" className="hover:text-red-700">
          SevenTech™ </a> all rights reserved.
        </span>
        <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
          <a href="https://www.facebook.com/rdragonbd/" className="text-gray-300 hover:text-gray-200">
