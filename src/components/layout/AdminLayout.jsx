        ...
        <aside className="w-64 md:block hidden" aria-label="Sidebar">
            <div className="overflow-y-auto h-full py-4 px-3 border-t-2 border-red-600 bg-black">
                <ul className="space-y-2">
                    ...
                    {/* <li>
                        <a href="#" className="flex items-center p-2 text-base font-normal text-red-600 rounded-lg hover:text-white hover:bg-red-600  ">
                            <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75   group-hover:text-red-600   " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
                    ...
                    <li>
                        <Link href="/admin/settings">
                            <a className="flex items-center p-2 text-base font-normal text-red-600 rounded-lg hover:text-white hover:bg-red-600  ">
                                <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-6 h-6 transition duration-75   group-hover:text-red-600   " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
