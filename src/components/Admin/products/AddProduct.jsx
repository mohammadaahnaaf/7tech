                        ...
                        <div className='grid grid-cols-2 gap-2 bg-teal-100 rounded-md px-2 mt-3 py-2'>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input datepicker="true" id='offerEndDate' name='offerEndDate' type="date" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-600 focus:border-red-500 block w-full pl-10" placeholder="Set a date" />
                                </div>
                            </div>
                        </div>
                    </div>
