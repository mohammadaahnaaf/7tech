                        ...
                        <div className="px-4 py-5 ring-2 ring-red-600 sm:p-6">
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6">
                                    <label htmlFor="first-name" className="block text-sm font-medium text-red-700">
                                        Your name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="col-span-6">
                                    <label htmlFor="country" className="block text-sm font-medium text-red-700">
                                        Country
                                    </label>
                                    <select
                                        id="country"
                                            ...
                                            <div className="col-span-3 sm:col-span-2">
                                                ...
                                                <div className="mt-1 flex rounded-md shadow-sm">
                                                    ...
                                                    <input
                                                        ...
                                                        id="company-website"
                                                        className="focus:ring-red-600 focus:border-red-600 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                            ...
                                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                                <div className="space-y-1 text-center">
                                                    ...
                                                    <div className="flex text-sm text-gray-600">
                                                        <label
                                                            htmlFor="file-upload"
                                                            className="relative cursor-pointer bg-white rounded-md font-medium text-red-600 hover:text-red-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-red-600"
                                                        >
                            ...
                            <form action="#" method="POST">
                                <div className="shadow overflow-hidden sm:rounded-md">
                                    ...
                                    <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                        <button
                                            type="submit"
                                            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600"
                                        >
                                            Saves
                                        </button>
                                    </div>
